...
const HistoryCard = ({ imageUrl, cardData, onLikeToggle }) => {
        ...
        <div className="card-body">
          <div className="text-section">
            ...
            <div className="card-foot">
              ...
              <Link
                to={`/leaderboard?testid=${cardData.testId}`}
                className="history-stats-btn"
              >
                <button
                  className="view-btn btn history-stats-btn"
